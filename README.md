...
in your browser, open Strudel. you will probably need to run a [local build](https://codeberg.org/uzu/strudel#running-locally) (or mess with browser security settings - bad idea) for the browser to allow connecting to the websocket on localhost.
